...
(function (Aufgabe8_Bienen) {
    class DaisyBlue extends Aufgabe8_Bienen.Flower {
        constructor(_x, _y) {
            super(_x, _y);
            console.log("create DaisyBlue");
        }
        drawDaisyBlue() {
            //grüner Stil
            ...
            Aufgabe8_Bienen.crc2.fillStyle = "#00BFFF";
            Aufgabe8_Bienen.crc2.fill();
            Aufgabe8_Bienen.crc2.closePath();
            Aufgabe8_Bienen.crc2.beginPath();
            Aufgabe8_Bienen.crc2.arc(this.x + 5, this.y - 40, 9, 0, Math.PI * 2);
    ...
    Aufgabe8_Bienen.DaisyBlue = DaisyBlue;
})(Aufgabe8_Bienen || (Aufgabe8_Bienen = {}));
//# sourceMappingURL=daisyblue.js.map