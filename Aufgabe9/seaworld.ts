...
namespace Aufgabe9_Seaworld {
    ...
    function init(_event: Event): void {
        ...
        for (var i: number = 0; i < 10; i++) {
            let fish: number = Math.floor((Math.random() * 4) + 0);
            let _x: number = (Math.random() * (900 - 50)) + 50;
            let _y: number = (Math.random() * (600 - 50)) + 50;
...
//        drawFish(300, 600);
      ...
      //Blasen Zufallsanordnung
        for (var i: number = 0; i < 20; i++) {
            ...
            let _x: number = (Math.random() * (550 - 450)) + 450;
            let _y: number = (Math.random() * (600 - 100)) + 100;
    ...
    function drawBigBubble(_x: number, _y: number): void {
        crc2.beginPath();
        crc2.moveTo(_x, _y);
        crc2.beginPath();
    ...
    function drawSmallBubble(_x: number, _y: number): void {
        crc2.beginPath();
        crc2.moveTo(_x, _y);
        crc2.beginPath();
